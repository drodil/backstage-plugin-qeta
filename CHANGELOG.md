...
* **qeta-backend:** add postId and answerId to Comment for permission validation ([d7d5ad2](https://github.com/drodil/backstage-plugin-qeta/commit/d7d5ad2668fae039d0cefc4c1a67bc8596e9ace3))

### [3.59.5](https://github.com/drodil/backstage-plugin-qeta/compare/v3.59.4...v3.59.5) (2026-04-15)

### [3.59.4](https://github.com/drodil/backstage-plugin-qeta/compare/v3.59.3...v3.59.4) (2026-04-15)
...
* remove typing of frontend plugin ([d8c3280](https://github.com/drodil/backstage-plugin-qeta/commit/d8c3280a34e9458d58ee7bf452b39180832fc01d))
...
* entities history + revert changes ([cc1c30b](https://github.com/drodil/backstage-plugin-qeta/commit/cc1c30baf33db61843d4cdcdd09b0cb3ec9756e5))

### [3.58.8](https://github.com/drodil/backstage-plugin-qeta/compare/v3.58.7...v3.58.8) (2026-02-26)


### Bug Fixes

* do not remove trgm on down ([42f3166](https://github.com/drodil/backstage-plugin-qeta/commit/42f3166f0692809329e0f7f2a67a5cc52edbb5cc))
* optional trgm indexes ([8e46be2](https://github.com/drodil/backstage-plugin-qeta/commit/8e46be2aa087513935fd2da0df8177b331f6581c))

### [3.58.7](https://github.com/drodil/backstage-plugin-qeta/compare/v3.58.6...v3.58.7) (2026-02-18)


### Bug Fixes

* publish config ([07ee65e](https://github.com/drodil/backstage-plugin-qeta/commit/07ee65e775207d400ef3c773c295acb8c21a7986))

### [3.58.6](https://github.com/drodil/backstage-plugin-qeta/compare/v3.58.5...v3.58.6) (2026-02-18)

### [3.58.5](https://github.com/drodil/backstage-plugin-qeta/compare/v3.58.4...v3.58.5) (2026-02-18)


### Bug Fixes

* entity reference checking ([292e35f](https://github.com/drodil/backstage-plugin-qeta/commit/292e35f6a85ce61fad761cb101dd4cf91e81cafb)), closes [#402](https://github.com/drodil/backstage-plugin-qeta/issues/402)
* stringify entity refs too ([8534121](https://github.com/drodil/backstage-plugin-qeta/commit/8534121a3460a8efadbb4f0b670119fa86d02d37))
...
* adjust inline code formatting in MarkdownRenderer [#397](https://github.com/drodil/backstage-plugin-qeta/issues/397) ([5a6b014](https://github.com/drodil/backstage-plugin-qeta/commit/5a6b014735b986c777d2c919b0ce1398b36dd069))
...
* batch url metadata requests ([196b64e](https://github.com/drodil/backstage-plugin-qeta/commit/196b64e764eaa8a3e7dfb031c98830709fa1c252))
* multiple requests to followed entities endpoint ([508ea19](https://github.com/drodil/backstage-plugin-qeta/commit/508ea19a592684b3622e3caab035ed48e7a73b9a))
* tests for async collection handling ([f1af759](https://github.com/drodil/backstage-plugin-qeta/commit/f1af7592f4b82d24c4148e3423297179faf481f3))
* unnecessary posts loading in collections page ([e5b63f2](https://github.com/drodil/backstage-plugin-qeta/commit/e5b63f25d54b68297af63d1f8d54b6da7eeb267f))
...
* moderators can do anything in default permission policy ([220220d](https://github.com/drodil/backstage-plugin-qeta/commit/220220ddc52f94f54a78d132ce7147e076ef953f))
...
* user settings saving ([2feff16](https://github.com/drodil/backstage-plugin-qeta/commit/2feff1632016692f3c913034e1e2f1f155ed6ec7))
...
* unit tests for correct answer mapping ([3b248b0](https://github.com/drodil/backstage-plugin-qeta/commit/3b248b05b5f19cc4e4fd65f11997db1ecfbd0034))
...
* duplicate views logged on post page ([3dec42d](https://github.com/drodil/backstage-plugin-qeta/commit/3dec42da04734d49b299543f0b344760f333c5d7))
* views test ([32ad45b](https://github.com/drodil/backstage-plugin-qeta/commit/32ad45b84e7a9300eb17d0198a6d0d8d5445fb7e))
...
* custom author validation in edit ([c8d06ff](https://github.com/drodil/backstage-plugin-qeta/commit/c8d06ffad22acd2daffd515f207e33bbebde356c))
