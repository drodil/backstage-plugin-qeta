export const TAGS: Record<string, string> = {
  ...
  data: 'Data is a collection of facts, such as numbers, words, measurements, observations, or descriptions of things.',
  spring:
  ...
  shell:
    'Shell is a command-line interpreter that provides a traditional user interface for the Unix operating system and for Unix-like systems.',
  zsh: 'Zsh is a Unix shell that can be used as an interactive login shell and as a powerful command interpreter for shell scripting.',
  ubuntu: 'Ubuntu is a Linux distribution based on Debian.',
  debian:
  ...
  playwright:
    'Playwright is a Node.js library to automate the Chromium, WebKit, and Firefox browsers.',
  puppeteer:
    'Puppeteer is a Node library that provides a high-level API over the Chrome DevTools Protocol.',
  'api-management':
    'API management is the process of creating and publishing web APIs.',
  'api-design':
    'API design is the process of developing application programming interfaces (APIs) that define the interactions between software intermediaries.',
  'api-documentation':
    'API documentation is a deliverable that provides guidance on how to use an API.',
  ssl: 'SSL (Secure Sockets Layer) is a standard security protocol for establishing encrypted links between a web server and a browser in an online communication.',
  tls: 'TLS (Transport Layer Security) is a cryptographic protocol designed to provide secure communication over a computer network.',
  https:
  ...
  udp: 'UDP (User Datagram Protocol) is one of the core members of the Internet protocol suite.',
  ip: 'IP (Internet Protocol) is the principal communications protocol in the Internet protocol suite for relaying datagrams across network boundaries.',
  ...
  'deep-learning':
    'Deep learning is a subset of machine learning that uses artificial neural networks to model and make decisions based on data.',
  'neural-networks':
    'Neural networks are a series of algorithms that mimic the operations of a human brain to recognize relationships in vast amounts of data.',
  ...
  tableau:
    'Tableau is a data visualization tool used in the business intelligence industry.',
  powerbi: 'Power BI is a business analytics tool developed by Microsoft.',
  'google-analytics':
  ...
  url: 'URL (Uniform Resource Locator) is a reference to a web resource that specifies its location on a computer network and a mechanism for retrieving it.',
  gcc: 'GCC (GNU Compiler Collection) is a compiler system produced by the GNU Project supporting various programming languages.',
  clang:
  ...
  web: 'Web development is the work involved in developing a website for the Internet or an intranet.',
  'front-end':
    'Front-end development is the practice of producing HTML, CSS, and JavaScript for a website or web application.',
  'back-end': 'Back-end development is the server-side of web development.',
  'full-stack':
  ...
  edge: 'Microsoft Edge is a web browser developed by Microsoft.',
  'web-assembly':
  ...
  cpu: 'CPU (Central Processing Unit) is the part of a computer that performs instructions.',
  gpu: 'GPU (Graphics Processing Unit) is a specialized electronic circuit designed to rapidly manipulate and alter memory to accelerate the creation of images in a frame buffer intended for output to a display.',
  'docker-compose':
    'Docker Compose is a tool for defining and running multi-container Docker applications.',
  sed: 'sed (stream editor) is a Unix utility that parses and transforms text.',
  ...
  testcafe: 'TestCafe is a Node.js tool to automate end-to-end web testing.',
  cypress: 'Cypress is a front-end testing tool built for the modern web.',
  'react-testing-library':
    'React Testing Library is a library for testing React components.',
  'jest-dom': 'jest-dom is a library for testing DOM elements with Jest.',
  'react-query':
    'React Query is a data-fetching library for React applications.',
  pip: 'pip is a package installer for Python.',
  ...
  'material-ui': 'Material-UI is a React component library.',
  oauth: 'OAuth is an open standard for access delegation.',
  ...
  cron: 'Cron is a time-based job scheduler in Unix-like operating systems.',
  hyperlink:
    'A hyperlink is a reference to data that the reader can follow by clicking or tapping.',
  'web-scraping':
