...
export const qetaTranslationRef = createTranslationRef({
  ...
  messages: {
    ...
    postHistory: {
      ...
      revisionBy: 'by {{author}}',
      viewRevision: 'View',
      restoreRevision: 'Restore',
      restoreConfirmTitle: 'Restore this revision?',
      restoreConfirmDescription:
        'This will replace the current post content with this revision. The current version will be saved as a new revision.',
