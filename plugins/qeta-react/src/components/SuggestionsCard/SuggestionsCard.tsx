...
const NewArticleSuggestionItem = (props: {
  ...
  return (
    <SuggestionListItem
      ...
      timestamp={<RelativeTimeWithTooltip value={getPostDisplayDate(suggestion.article)} />}
    >
...
const NewLinkSuggestionItem = (props: { suggestion: NewLinkSuggestion }) => {
  ...
  return (
    <SuggestionListItem
      ...
      icon={<LinkIcon />}
      timestamp={<RelativeTimeWithTooltip value={getPostDisplayDate(suggestion.link)} />}
    >
